...
PRIORITY_IPD = num_IPD_array_2           # 定义M-IPD的编号为动作空间中的最后一个取值在这里即为10，要优先给M-IPD进行带宽资源的分配
...
class MyEnv3(gym.Env):
    ...
    def reset(self):
        ...
        self.allocation[num_F] = config_MIPD.glo_band_M  # M-IPD所分配的带宽                                                                      # 初始分配，每个设备都至少分配一个子载波
