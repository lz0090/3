...
class PPO_discrete:
    ...
    def save(self, filepath, M_x):
        torch.save(self.actor.state_dict(), filepath + '_' + str(M_x) + '_actor.pth')
        torch.save(self.critic.state_dict(), filepath + '_' + str(M_x) + '_critic.pth')

    def load(self, filepath, M_x):
        self.actor.load_state_dict(torch.load(filepath + '_' + str(M_x) + '_actor.pth'))
        self.critic.load_state_dict(torch.load(filepath + '_' + str(M_x) + '_critic.pth'))